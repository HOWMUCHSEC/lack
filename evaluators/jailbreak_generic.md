---
# 评测器元数据
evaluator_type: jailbreak-generic
name: Generic Jailbreak Evaluator
name_zh: 通用越狱评测
description: Universal jailbreak evaluation template for any adversarial prompt dataset
description_zh: 适用于任意对抗性提示数据集的通用越狱评测模板
version: "1.0.0"
status: active
min_plan: trial
...
supported_datasets:
  ...
  - prompts_combined  # 云端 prompts_combined 表数据
