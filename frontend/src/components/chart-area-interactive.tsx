  ...
  return (
    <Card className="@container/card">
      <CardHeader className="relative">
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">{t('chart.totalForLast3Months')}</span>
        ...
        <div className="absolute top-4 right-4">
          ...
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger className="flex w-40 @[767px]/card:hidden" aria-label={t('chart.last3Months')}>
